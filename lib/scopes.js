            ...
            if (!(ignoredChars.includes(ch) || !canMatch || (ch == ' ' && code[i + 1] == ' '))) {
                ...
                if (ch == '{') {
                    ...
                    if (methMatch = currentScope.name.match(this.re.method)) {
                        ...
                        let params = [];
                        for (param of methMatch[5].split(',')) {
                            let par = {};
                            param = param.trim ();
                        ...
                        if (currentScope.top.data && currentScope.top.data.type == 'class' && methMatch[4].split('.')[0] == currentScope.top.data.name) {
                            // not a method, but a constructor
                            currentScope.data = {
                                type: 'ctor',
                                name: methMatch[4],
                                access: methMatch[3],
                                parameters: methMatch[5],
                    ...
                    if (propMatch = currentScope.name.match(this.re.prop)) {
                        if (propMatch[3] != 'enum' && propMatch[3] != 'errordomain') {
                            currentScope.data = {
                                type: 'property',
                                name: propMatch[5],
                ...
                if (ch == ';') {
                    ...
                    if (methMatch) {
                        ...
                        if (currentScope.data && currentScope.data.type == 'class' && methMatch[4].split('.')[0] == currentScope.data.name) {
                            // not a method, but a constructor
                            currentScope.children.push ({
                                top: currentScope,
